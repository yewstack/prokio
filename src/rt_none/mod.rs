...
static NO_RUNTIME_NOTICE: &str = "No runtime configured for this platform, features that requires \
                                  a runtime can't be used. Either compile with `target_arch = \
                                  \"wasm32\", or enable the `tokio` feature.";
